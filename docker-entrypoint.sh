...
if [ ${MYSQLBSI} ]; then
    eval WORDPRESS_DB_HOST=\$BSI_${BSITYPE}_${MYSQLBSI}_HOST
    eval WORDPRESS_DB_USER=\$BSI_${BSITYPE}_${MYSQLBSI}_USERNAME  
    eval WORDPRESS_DB_PASSWORD=\$BSI_${BSITYPE}_${MYSQLBSI}_PASSWORD 
    eval WORDPRESS_DB_NAME=\$BSI_${BSITYPE}_${MYSQLBSI}_NAME 
fi

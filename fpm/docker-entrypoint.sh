...
if [ -z "MYSQLBSI" ]; then
    ...
    eval echo BSI_${MYSQLBSI}_USERNAME:\$BSI_${MYSQLBSI}_USERNAME
    eval WORDPRESS_DB_USER=\$BSI_${MYSQLBSI}_USERNAME  
    
    eval echo BSI_${MYSQLBSI}_PASSWORD:\$BSI_${MYSQLBSI}_PASSWORD
    eval WORDPRESS_DB_PASSWORD=\$BSI_${MYSQLBSI}_PASSWORD 
    
    eval echo BSI_${MYSQLBSI}_NAME:\$BSI_${MYSQLBSI}_NAME
